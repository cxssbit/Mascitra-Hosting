       <div class="content">
            <div class="animated fadeIn">
              <form action="<?=base_url('team/tambah')?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="input-2" placeholder="Jabatan" name="position">
                                </div>
                                <div class="form-group">
                                  <label for="input-3">Skill</label>
                                  <input type="text" id="multiple" placeholder="Skill" name="skill">
                                </div>
                                <div class="form-group">
                                  <label for="editor1">Bio</label>
                                  <textarea class="form-control" rows="10" cols="80" name="bio"></textarea>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top" height="200" id="preview" src="<?=base_url()?>assets/img/team-img/01.jpg" alt="Profile Image">
                            <div class="card-body">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="gplus">
                                    </div>
                                </div>
                            </div>
                        </div>
