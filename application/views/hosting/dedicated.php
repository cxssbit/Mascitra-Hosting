    ...
    <div id="banner">
        ...
        <div class="banner-slider" data-pagination="true">
            <!-- Banner Item Start -->
            <div class="banner-item bg--overlay" data-bg-img="<?=base_url()?>assets/img/dedicated-slider-img/slider-bg-01.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    ...
                                    <section class="banner-item-content">
                                        <h1><span>Dedicated</span> Hosting Basic</h1>
                            ...
                            <div class="vc-parent">
                                <div class="vc-child">
                                    ...
                                    <div class="banner-item-img">
                                        <img src="<?=base_url()?>assets/img/dedicated-slider-img/slider-item-01.png" alt="" class="img-responsive">
                                    </div>
            ...
            <!-- Banner Item Start -->
            <div class="banner-item bg--overlay" data-bg-img="<?=base_url()?>assets/img/dedicated-slider-img/slider-bg-02.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 hidden-sm hidden-xs">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <!-- Banner Item Image Start -->
                                    <div class="banner-item-img">
                                        <img src="<?=base_url()?>assets/img/dedicated-slider-img/slider-item-02.png" alt="" class="img-responsive">
                                    </div>
                                    <!-- Banner Item Image End -->
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <!-- Banner Item Content Start -->
                                    <section class="banner-item-content">
                                        <h1><span>Dedicated</span> Hosting Pro</h1>
            ...
            <!-- Banner Item Start -->
            <div class="banner-item bg--overlay" data-bg-img="<?=base_url()?>assets/img/dedicated-slider-img/slider-bg-03.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <!-- Banner Item Content Start -->
                                    <section class="banner-item-content">
                                        <h1><span>Dedicated</span> Hosting Business</h1>
                        ...
                        <div class="col-md-6 hidden-sm hidden-xs">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <!-- Banner Item Image Start -->
                                    <div class="banner-item-img">
                                        <img src="<?=base_url()?>assets/img/dedicated-slider-img/slider-item-03.png" alt="" class="img-responsive">
                                    </div>
                                    <!-- Banner Item Image End -->
                                </div>
                            </div>
                ...
                <div class="pricing--item">
                    <div class="pricing--content">
                        <div class="pt-head">
                            ...
                            <div class="pt-plan">Dedicated Basic</div>
                        </div>
                ...
                <div class="pricing--item">
                    <div class="pricing--content">
                        <div class="pt-head">
                            ...
                            <div class="pt-plan">Dedicated Pro</div>
                        </div>
                ...
                <div class="pricing--item">
                    <div class="pricing--content">
                        <div class="pt-head">
                            ...
                            <div class="pt-plan">Dedicated Business</div>
                        </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label="CUPON">10offall</td>
                        <td data-label="ORDER"><a href="#" class="btn btn-custom">Order Now</a></td>
                    </tr>
                    <tr>
                        <td data-label="SERVER">Intel® i5-4590  New (Quad-Core, 4x 3,7 Ghz)</td>
                        <td data-label="CPU">3.7 GHz</td>
